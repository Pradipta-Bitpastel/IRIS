...
const LeftPanel = () => {
  ...
  return (
    <>
      {
        ((pathName.split("/")[1] === "dashboard") || (pathName.split("/")[1] === "search") || (pathName.split("/")[1] === "alertsetting")) &&
            ...
            <div className="container-fluid">
              <div className="dashboard_header_content">
                <div className="dashboard_header_wrapper">
                  <h1 className="text-white">{pathName.split("/")[1] === "dashboard" ? "Dashboard" : (pathName.split("/")[1] === "search") ? "Search" : (pathName.split("/")[1] === "alertsetting") ? "Alert" : null}</h1>
