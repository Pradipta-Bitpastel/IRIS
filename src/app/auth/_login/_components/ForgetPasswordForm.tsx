...
const ForgetPasswordForm = ({handleClickShowPassword,showPassword,setShowPassword,changeInput,submitForm,inputValue,setInputValue,formError,setFormError,setAuthPage}:TProp) => {
  return (
