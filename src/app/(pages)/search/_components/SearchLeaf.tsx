...
const SearchLeaf = ({ params }: { params: { id: string; type: string } }) => {
  ...
  useEffect(() => {
    if (params && Object.keys(params).length > 0) {
      ...
      // alert(btnSelction)
      // goToDetailsPage(JSON.stringify(`${searchParams.get('type')}-${searchParams.get('id')}`))
      // setShowLabel(() => {
      //   return { ...showLabel, searchStr: searchParams.get("keyword") };

      // });
      // setSearchInput(() => { return { ...searchInput, inputVal: searchParams.get("keyword") } })
  ...
  const goToDetailsPage = async (event: React.MouseEvent<HTMLDivElement, MouseEvent> | string) => {
    ...
    // console.log(groupList,"grouplistt")
    // setCloneMemberGroup(member_group_map)
  ...
  const handleFilterInputChange = async (
                                                ...
                                                <div className="search_result_inner_people_card_left">
                                                  ...
                                                  <div className="search_result_inner_people_content">
                                                    ...
                                                    <div className="d-flex">
                                                      ...
                                                      {/* <Link href={`/search/${searchItem.id}`} onClick={()=>{console.log("clkickk")}}> */}
                                                    </div>
                                                  </div>
                                                </div>
                                                ...
                                                <div className="search_result_inner_people_content">
                                                  ...
                                                  <div className="inner_card_group_risk">
                                                    ...
                                                    <div className="inner_card_group_risk_svg">
                                                      ...
                                                      />
                                                      <span
                                                        className={`${searchItem?.risk_score
                                                          ? `${riskFactorCalc(
                                                            searchItem?.risk_score || '20%'
                                                          )?.className
                                                          }`
