...
const PersonDetailView = memo(({
  ...
  console.log(entityMessages, "entityDetails");
        ...
        <div className="search_result_inner_people_details">
          ...
          <div className="search_result_inner_people_profile_area ">
            ...
            <div className="classification">
              ...
              <p>{entityDetails?.classification ? entityDetails?.classification : "N/A"}</p>
            </div>
                                      ...
                                      <div className="search_result_inner_people_card_left">
                                        <div className="search_result_inner_people_content_area">
                                          ...
                                          <div className="d-flex justify-content-between mt-1">
                                            ...
                                            {
                                              (messageOfMemberObj?.language !== 'en' && messageOfMemberObj?.language !== 'km' && messageOfMemberObj?.language !== 'da' && messageOfMemberObj?.language != 'zh' && messageOfMemberObj?.language !== 'unknown' && messageOfMemberObj?.language) || (messageOfMemberObj?.language == 'ja') ?
                                                <div className="translator-btn">
                                                  <span
                                                    onClick={() => ArabicTranslation(messageOfMemberObj?.message_text, messageOfMemberObj?.id)}
                                                    className={
                                                      translateData.some(
                                                        (translation) =>
                                                          translation.messageId === messageOfMemberObj?.id && translation.status
                                                      )
                                                        ? "active"
                                                        : ""
                                                    }
