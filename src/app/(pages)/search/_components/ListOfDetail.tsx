...
const ListOfDetail = memo(({ listDetail, setListDetail, listDetailInfo, restrictUseEffectFromInitialRendering, changePage, inputVal, searchStr, goToDetailsPage, postSearchByKeyApiRequest, setSearchResultSectionLoader, filterPayload, sortingValue }: TProp) => {
                ...
                <div className="search_result_inner_peoples">
                  <div className="pagination">
                    <Pagination
                      ...
                      page={page}
                      onChange={(event, value) => { console.log("page change"); setPage(value) }}
                      // defaultPage={}
                      boundaryCount={2}
                      siblingCount={0}
                    //   showFirstButton
                  ...
                  />
                  <TableContainer>
                    <div className="search_result_inner_people_list">
                      {
