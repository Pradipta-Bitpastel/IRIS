...
const ListOfDetail = ({ listDetail, setListDetail, listDetailInfo, restrictUseEffectFromInitialRendering, changePage, inputVal, searchStr, goToDetailsPage, postSearchByKeyApiRequest, setSearchResultSectionLoader, filterPayload, sortingValue }: TProp) => {
