                          ...
                          return (
                            <div key={index} className={`search_group_details_inner_card relative_pos ${deletedData.includes(index) ? "deleted" : ""}`}>
                              ...
                              <div className="search_group_details_inner_card_image details-clickable-img-zIndex">
                                <img onClick={goToDetailsPage} id={`entity-${item?.entity?.id}`} src={`${item?.entity?.profile_image_url}`} className="img-fluid" alt="people image" />
                              </div>
                              ...
                              <div className="search_group_details_inner_card_content">
                                    ...
                                    <div className="media-container">
                                      {(() => {
                                        ...
                                        if (eachMediaType === "image") {
                                          return (
                                            <img
                                              src={item.message_media.thumbnail_url || item.message_media.media_url}
                                              alt="media thumbnail"
                                              className="img-fluid"
                                              id={`id-${item?.id}`}
                                              onClick={openLightBox}  // Update: Use media URL for lightbox
                                          ...
                                          return (
                                            <div className="media-gallery-card">
                                              <div className="media-gallery-card-inner-img">
                                                <img
                                                  src={`${item?.message_media?.thumbnail_url || video_icon_path}`}
                                                  className="img-fluid"
                                                  onClick={openLightBox}  // Update: Use media URL for lightbox
                                                  id={`id-${item?.id}`}
                                                />
                                ...
                                <div className="translator-btn">
                                  {item?.message_media ? (
                                    ...
                                    item.language == 'ar' || item.language == 'fa' ?
                                      <span
